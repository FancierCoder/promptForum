...
import xyz.forum.model.VO.AddFriendVo;
import xyz.forum.model.VO.UnreadComm;
import xyz.forum.util.MD5Util;
import xyz.forum.util.R;
import xyz.forum.websocket.SixinHandler;
import xyz.forum.websocket.SystemWebSocketHandler;
    ...
    public String toManage(HttpServletRequest request) {
        ...
        try {
            ...
            if (admin == null)
                ...
                readPro();
                request.getSession(false).setAttribute("forumName", forumName);
                return "manage";
            }
        } catch (Exception e) {
            return "redirect:/login2.html";
