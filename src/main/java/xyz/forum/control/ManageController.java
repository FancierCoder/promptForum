...
import xyz.forum.util.DateUtil;
import xyz.forum.util.LevelUtil;
...
public class ManageController {
    ...
    public void cancelToTop(@RequestParam("tid") long tid, HttpServletResponse response) throws IOException {
        Topic t = new Topic();
        t.setTid(tid);
        t.setTstaus(0);
