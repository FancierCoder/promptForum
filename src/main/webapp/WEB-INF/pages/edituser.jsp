    ...
    <div class="form-horizontal">
        <div class="row ">
            ...
            <div class="form-group col-sm-6  col-sm-offset-6">
                ...
                <div class="col-sm-8 ">
                    <input type="text" placeholder="密码" value="${selectUser.unickname}" id="unickname"
                           class="form-control">
                </div>
            </div>
            <div class="form-group col-sm-6">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-sm-8 ">
                    <input type="text" readonly value='<fmt:formatDate value="${selectUser.ubirthday}" type="date"/>'
                           class="form-control"/>
                </div>
            </div>
        ...
        if (nickname == '' || password == '' || sex == '' || birthday == '' || statement == '' || state == '' || point == '') {
            ...
            if (!rpassword.test(password)) {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    data: {
                        uid: '${selectUser.uid}', uemail: $('#uemail').val(), unickname: nickname,
