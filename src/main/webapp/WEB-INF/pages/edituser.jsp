    ...
    <div class="form-horizontal">
        <div class="row ">
            ...
            <div class="form-group col-sm-6  col-sm-offset-6">
                ...
                <div class="col-sm-8 ">
                    <input type="text" placeholder="昵称" value="${selectUser.unickname}" id="unickname"
                           class="form-control">
                </div>
            </div>
            <div class="form-group col-sm-6">
            ...
            <%--<div class="form-group col-sm-6">
                ...
                <div class="col-sm-8 ">
                    <input type="text" readonly value="${selectUser.upassword}" id="upassword" class="form-control">
                </div>
            </div>--%>
            <div class="form-group col-sm-6">
                ...
                <div class="col-sm-8 ">
                    <select type="text" id="usex" class="form-control">
                        <option value=0
                                <c:if test="${selectUser.usex eq 0}">selected</c:if> >男
                        </option>
                        <option value=1 <c:if test="${selectUser.usex eq 1}">selected</c:if>>女</option>
                        <option value=2 <c:if test="${selectUser.usex eq 2}">selected</c:if>>保密</option>
                    </select>
                </div>
            </div>
            <div class="form-group col-sm-6">
            ...
            <div class="form-group col-sm-6">
                ...
                <div class="col-sm-8 ">
                    <input type="text" readonly value='<fmt:formatDate value="${selectUser.uregtime}" type="date"/>'
                           class="form-control"/>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $('#submit').on('click', function () {
        ...
        if (nickname == '' || sex == '' || birthday == '' || statement == '' || state == '' || point == '') {
            ...
            if (state < -1) {
                ...
                $.ajax({
                    url: "${staticPath}/manage/meditupdateuser",
                    type: 'post',
                    data: {
                        uid: $('#uid').val(), uemail: $('#uemail').val(), unickname: nickname,
                        usex: sex, ubirthday: birthday, ustatement: statement,
